...
const Generator = () => {
    ...
    const [upsertGenerator] = useMutation(UPSERT_GEN);
        ...
        <>
            <div>
                ...
                <Modal
                    ...
                    width={600}>
                    <br />
                    <h1 style={{fontFamily:"Bold",alignContent:"center"}}>Generator Form</h1>
                    <br />
                    <Row>
            ...
            <GenList refetch={refetch} forEdit={getForEdit} />
        </>
    )
}
